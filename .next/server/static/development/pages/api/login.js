...
const login = async (request, response) => {
  await _lib_auth0__WEBPACK_IMPORTED_MODULE_0__["default"].handleLogin(request, response);
};
...
module.exports = __webpack_require__(/*! /mnt/hd1tb/develop/cursos/fullstacklab20/mydailystatus/pages/api/login.js */"./pages/api/login.js");
